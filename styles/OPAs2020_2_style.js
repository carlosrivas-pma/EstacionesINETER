...
var style_OPAs2020_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = "";
    size = 0;
    var labelFont = "15.600000000000001px \'Tw Cen MT\', sans-serif";
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("OPA") !== null && resolution > 0 && resolution < 280) {
        labelText = String(feature.get("OPA"));
    }
